...
import 'package:JF_InfoTech/pages/cart/cart_page.dart';
...
class RecommendedItemDetail extends StatelessWidget {
  final int pageId;
  final String page;
  const RecommendedItemDetail({Key? key, required this.pageId,required this.page})
      : super(key: key);
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: //Image.asset("assets/image/hp4.png",
                 Image .network(
