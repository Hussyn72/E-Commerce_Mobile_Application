...
import 'package:JF_InfoTech/models/cart_models.dart';
...
bool get isLoaded => _isLoaded;
 ...
 int _quantity= 0;
 int get quantity => _quantity;//error function returns in the same/one line
  int _inCartItems=0;
  ...
  void setQuantity(bool isIncrement){
    ...
    update();//function inside getx flutter package this will gonna update ui
  }
   ...
   int checkQuantity(int quantity){
    if((_inCartItems+quantity)<0){
      ...
      Get.snackbar("Item count", "You can't add0 more !",
        backgroundColor: AppColors.mainColor,
        colorText: Colors.white,
      );
       return 50;
